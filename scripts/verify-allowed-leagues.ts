...
const cases: Case[] = [
  ...
  { id: 61, name: "Ligue 1", allow: true, why: "France Ligue 1" },
  { id: 62, name: "Ligue 2", allow: true, why: "France Ligue 2" },
  { id: 66, name: "Coupe de France", allow: true, why: "Coupe de France" },
  { name: "Coupe de France", allow: true, why: "Coupe de France by name" },
  { id: 78, name: "Bundesliga", allow: true, why: "Bundesliga" },
  { id: 79, name: "2. Bundesliga", allow: true, why: "2. Bundesliga" },
  { id: 81, name: "DFB Pokal", allow: true, why: "DFB Pokal" },
  { name: "Bundesliga", allow: true, why: "Bundesliga by name" },
  { name: "DFB Pokal", allow: true, why: "DFB Pokal by name" },
  { id: 80, name: "3. Liga", allow: false, why: "3. Liga" },
  { id: 63, name: "National", allow: false, why: "France National" },
  { name: "3. Liga", allow: false, why: "3. Liga by name" },
  ...
  { id: 263, name: "Copa MX", allow: false, why: "Copa MX removed" },
  { name: "Copa MX", allow: false, why: "Copa MX by name" },
  ...
  { id: 254, name: "US Open Cup", allow: false, why: "US Open Cup removed" },
  { name: "US Open Cup", allow: false, why: "US Open Cup by name" },
